...
class BuilderTableCreateMacrobitDrugreqDrugs extends Migration
{
    public function up()
    {
        Schema::create('macrobit_drugreq_drugs', function($table)
        {
            $table->engine = 'InnoDB';
    ...
    {
        Schema::dropIfExists('macrobit_drugreq_drugs');
    }
}
